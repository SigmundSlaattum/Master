...
def prepare_song_legacy(
    ...
    try:
        ...
        print(f"\n[3/7] Generating fixed tempo COMPLEX trajectory...")
        ...
        print(f"\n[4/7] Generating dynamic tempo COMPLEX trajectory...")
        ...
        print(f"\n[5/7] Generating fixed tempo SIMPLE trajectory...")
        ...
        print(f"\n[6/7] Generating dynamic tempo SIMPLE trajectory...")
